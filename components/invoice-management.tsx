...
import {
  ...
  generateInvoiceWhatsAppContent,
} from "@/lib/utils";
...
export function InvoiceManagement() {
  ...
  const handleWhatsAppToContact = (
    invoice: Invoice,
    contact: WhatsAppContact,
  ) => {
    const whatsappUrl = generateInvoiceWhatsAppContent(
      invoice,
      products,
      contact.phone,
    );
    ...
    <div className="space-y-6">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Generate an invoice for a buyer with selected products
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-6">
              <div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            All generated invoices and their status
          </CardDescription>
        </CardHeader>
        <CardContent>
          {invoices.length === 0 ? (
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {viewingInvoice &&
                `Invoice ${viewingInvoice.id} for ${viewingInvoice.buyer_name}`}
            </DialogDescription>
          </DialogHeader>
          {viewingInvoice && (
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold">
                    {formatRupiah(viewingInvoice.total_amount)}
                  </p>
                </div>
                <div>
                  <Label className="text-sm font-medium text-muted-foreground">
          ...
          <DialogFooter>
            {viewingInvoice && (
              <>
                ...
                <Button
                  variant="outline"
                  onClick={() => openWhatsAppDialog(viewingInvoice)}
                >
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {whatsappInvoice &&
                `Select a contact to send invoice ${whatsappInvoice.id}`}
            </DialogDescription>
          </DialogHeader>
            ...
            {whatsappContacts.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground">
                  Add contacts in the WhatsApp Contacts menu first.
                </p>
              </div>
            ) : (
              <div className="space-y-2">
                {whatsappContacts.map((contact) => (
                  <div
                    ...
                    onClick={() =>
                      whatsappInvoice &&
                      handleWhatsAppToContact(whatsappInvoice, contact)
                    }
                  >
                    <div>
