    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your WhatsApp contacts for invoice sharing
          </p>
        </div>
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Add a new contact for sending invoices via WhatsApp
              </DialogDescription>
            </DialogHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your WhatsApp contacts for invoice sharing
          </CardDescription>
        </CardHeader>
        <CardContent>
          {contacts.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                No WhatsApp contacts found. Add your first contact to get
                started.
              </p>
            </div>
          ) : (
